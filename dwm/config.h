...
static const char *colors[][3]           = {          /* 颜色设置 ColFg, ColBg, ColBorder */ 
    ...
    [SchemeSelTag] = { "#CCFFBB", "#333333", NULL },
...
static const Rule rules[] = {
    ...
    /** 普通优先度 */
    {"obs",                  NULL,                 NULL,             1 << 3,       1,          0,          0,        -1,      0}, // obs        tag -> 
    {"firefox",              NULL,                 NULL,             1 << 4,       0,          0,          0,        -1,      0}, // firefox    tag -> 
    { NULL,                 "qq",                  NULL,             1 << 5,       0,          0,          1,        -1,      0}, // qq         tag -> ﬄ 无边框
    {"Vncviewer",            NULL,                 NULL,             0,            1,          0,          1,        -1,      2}, // Vncviewer           浮动、无边框 屏幕顶部
    {"flameshot",            NULL,                 NULL,             0,            1,          0,          0,        -1,      0}, // 火焰截图            浮动
    {"thunar",              "thunar",              NULL,             0,            1,          0,          0,        -1,      0}, 
    {"iwgtk",               "iwgtk",               NULL,             0,            1,          0,          0,        -1,      0}, 
...
static Key keys[] = {
    ...
    { MODKEY|ControlMask,  XK_F12,          spawn,          SHCMD("killall bar.sh dwm")},/* super ctrl f12     |  退出dwm */
    ...
    { MODKEY,              XK_p,      spawn, SHCMD("~/.config/chadwm/scripts/rofi.sh") },                       /* super p          | rofi: 执行自定义脚本   */
    { MODKEY,              XK_n,      spawn, SHCMD("~/.config/chadwm/scripts/blurlock.sh") },                   /* super n          | 锁定屏幕               */
...
static Button buttons[] = {
    ...
    /* 点击bar空白处 */
    { ClkBarEmpty,         0,               Button1,          spawn, SHCMD("~/.config/chadwm/scripts/rofi_sys.sh") }, // 左键        |  bar空白处    |  rofi 执行 window
